...
(function($) {
    ...
    VLTJS.contentSlider = {
        init: function() {
            ...
            var mobileResizeSwiper;
            var mobileResizeContainer;
            var mobileResizeConfig;
            ...
            $('.vlt-content-slider').each(function() {
                ...
                if (container.hasClass('swiper-container--mobile-resize')) {
                  mobileResizeSwiper = swiper;
                  mobileResizeContainer = container;
                  mobileResizeConfig = {
                    init: true,
                    spaceBetween: gap,
                    grabCursor: true,
              ...
              swiper.on('init slideChange', function () {
                ...
                var breakpointChecker = () => {
                  if (breakpoint.matches) {
                    mobileResizeSwiper.destroy(true, true);
                    mobileResizeSwiper = new Swiper(mobileResizeContainer, mobileResizeConfig);
                    $('.vlt-mobile-slider-controls').show();
                    $('.mobile-resize-control').hide();

                    if (!mobileResizeContainer.hasClass('is-hide')) {
                      mobileResizeContainer.addClass('is-hide');
                    }
                  } else {
                    mobileResizeSwiper.destroy(true, true);
                    $('.vlt-mobile-slider-controls').hide();
                    $('.mobile-resize-control').show();
                  }
                };

                if (mobileResizeSwiper) {
                  breakpoint.addListener(breakpointChecker);
                  breakpointChecker();

                  $('.mobile-resize-control-load-more').on('click', function (e) {
                    e.preventDefault();
                    mobileResizeContainer.removeClass('is-hide');
                    $('.mobile-resize-control').hide();
                  })
                }
              });
